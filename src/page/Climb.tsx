	...
	return (
		<section id="climb" className="w-full">
			<div className="bg-white max-w-[100rem] mx-auto w-full">
				<div className="flex flex-col md:flex-row items-center gap-4 md:gap-8 min-h-[5rem] text-cyan w-full py-2 px-4 md:px-8">
					<div className="flex flex-row items-center gap-[0.15rem] md:gap-1">
						...
						<div className="flex flex-col mb-[-1.8rem]">
							<span className="text-[2rem] font-semibold">CLIMB</span>
